...
In order to fund the contract run:

```shell
hardhat run --network ropsten scripts/fund.js
```

In order to withdraw fund to the creator's wallet run:

```shell
hardhat run --network ropsten scripts/withdraw.js
```
